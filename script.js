    ...
    muscle: {
        beginner: {
            dumbbells: [
                ...
                { name: "Dumbbell Lunges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 3, reps: 12, rest: 60, timePerSet: 60 },
                { name: "Dumbbell Chest Press", muscleGroup: "chest & triceps", label: "2", equipment: "Dumbbells", sets: 3, reps: 10, rest: 60, timePerSet: 45 },
                { name: "Dumbbell Romanian Deadlifts", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 3, reps: 12, rest: 60, timePerSet: 60 },
            ...
            bodyweight: [
                ...
                { name: "Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Bodyweight", sets: 3, reps: 12, rest: 60, timePerSet: 30 },
                { name: "Lunges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Bodyweight", sets: 3, reps: 12, rest: 60, timePerSet: 45 },
                ...
                { name: "Glute Bridges", muscleGroup: "legs & back, lower back, glutes", label: "1", equipment: "Bodyweight", sets: 3, reps: 15, rest: 60, timePerSet: 30 },
            ...
            barbells: [
                ...
                { name: "Barbell Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 3, reps: 8, rest: 75, timePerSet: 75 },
                ...
                { name: "Barbell Romanian Deadlifts", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 3, reps: 10, rest: 75, timePerSet: 75 },
        ...
        intermediate: {
            barbell: [
                ...
                { name: "Barbell Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 4, reps: 8, rest: 90, timePerSet: 90 },
                ...
                { name: "Barbell Deadlifts", muscleGroup: "legs & back, lower back", label: "1, 3", equipment: "Barbells", sets: 3, reps: 6, rest: 120, timePerSet: 90 }, // Multi-label
                { name: "Barbell Romanian Deadlifts", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 4, reps: 10, rest: 90, timePerSet: 90 },
                { name: "Barbell Hip Thrusts", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 4, reps: 10, rest: 90, timePerSet: 60 },
                { name: "Barbell Lunges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 4, reps: 10, rest: 90, timePerSet: 90 },
            ...
            machines: [
                ...
                { name: "Back Extension Machine", muscleGroup: "legs & back, lower back", label: "3", equipment: "Machines", sets: 3, reps: 15, rest: 90, timePerSet: 25 },
                { name: "Calf Raise Machine", muscleGroup: "legs & back, calves", label: "1", equipment: "Machines", sets: 3, reps: 15, rest: 60, timePerSet: 25 },
            ],
            dumbbells: [
                ...
                { name: "Dumbbell Romanian Deadlifts", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 4, reps: 12, rest: 75, timePerSet: 75 },
                { name: "Dumbbell Lunges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 4, reps: 12, rest: 75, timePerSet: 75 },
            ...
            bodyweight: [
                ...
                { name: "Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Bodyweight", sets: 4, reps: 15, rest: 60, timePerSet: 40 },
                { name: "Lunges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Bodyweight", sets: 4, reps: 15, rest: 60, timePerSet: 60 },
                ...
                { name: "Glute Bridges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Bodyweight", sets: 4, reps: 20, rest: 60, timePerSet: 35 },
                ...
                { name: "Superman", muscleGroup: "back & biceps, lower back", label: "3", equipment: "Bodyweight", sets: 4, reps: 20, rest: 60, timePerSet: 35 },
                { name: "Calf Raises (on a step)", muscleGroup: "legs & back, calves", label: "1", equipment: "Bodyweight", sets: 3, reps: 20, rest: 45, timePerSet: 20 },
            ],
        },
        advanced: {
            barbell: [
                ...
                { name: "Barbell Squats", muscleGroup: "legs & back, lower back, glutes", label: "1", equipment: "Barbells", sets: 4, reps: 6, rest: 120, timePerSet: 90 },
                { name: "Barbell Deadlifts", muscleGroup: "legs & back, lower back, glutes", label: "1, 3", equipment: "Barbells", sets: 3, reps: 5, rest: 180, timePerSet: 90 }, // Multi-label
                ...
                { name: "Barbell Hip Thrusts", muscleGroup: "legs & back, lower back, glutes", label: "1", equipment: "Barbells", sets: 4, reps: 8, rest: 120, timePerSet: 60 },
                { name: "Barbell Lunges", muscleGroup: "legs & back, lower back, glutes", label: "1", equipment: "Barbells", sets: 4, reps: 8, rest: 120, timePerSet: 90 },
            ...
            dumbbells: [
                ...
                { name: "Dumbbell Romanian Deadlifts", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 4, reps: 10, rest: 120, timePerSet: 90 },
                { name: "Dumbbell Lunges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 4, reps: 10, rest: 120, timePerSet: 90 },
                ...
                { name: "Dumbbell Goblet Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 4, reps: 10, rest: 120, timePerSet: 75 },
                { name: "Dumbbell Calf Raises", muscleGroup: "legs, calves", label: "1", equipment: "Dumbbells", sets: 3, reps: 15, rest: 45, timePerSet: 25 },
            ],
            machines: [
                { name: "Leg Press Machine", muscleGroup: "legs & back", label: "1", equipment: "Machines", sets: 3, reps: 10, rest: 90, timePerSet: 40 },
                { name: "Chest Press Machine", muscleGroup: "chest & triceps", label: "2", equipment: "Machines", sets: 3, reps: 10, rest: 90, timePerSet: 40 },
            ...
            bodyweight: [
                ...
                { name: "Pistol Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Bodyweight", sets: 3, reps: 6, rest: 120, timePerSet: 75 },
...
strength: {
        beginner: {
            bodyweight: [
                ...
                { name: "Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Bodyweight", sets: 3, reps: 10, rest: 90, timePerSet: 30 },
                ...
                { name: "Glute Bridges", muscleGroup: "legs & back, lower back, glutes", label: "1", equipment: "Bodyweight", sets: 3, reps: 12, rest: 90, timePerSet: 20 },
                { name: "Walking Lunges", muscleGroup: "legs & back, core & cardio, lower back, glutes", label: "1", equipment: "Bodyweight", sets: 3, reps: 10, rest: 90, timePerSet: 60 },
                ...
                { name: "Supermans", muscleGroup: "back & biceps, lower back", label: "3", equipment: "Bodyweight", sets: 3, reps: 12, rest: 90, timePerSet: 20 },
                { name: "Knee Push ups", muscleGroup: "chest & triceps", label: "2", equipment: "Bodyweight", sets: 3, reps: 12, rest: 90, timePerSet: 20 },
                { name: "Calf Raises (on a step)", muscleGroup: "legs & back, calves", label: "1", equipment: "Bodyweight", sets: 3, reps: 20, rest: 45, timePerSet: 20 },
            ],
            dumbbells: [
                { name: "Dumbbell Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 3, reps: 8, rest: 90, timePerSet: 45 },
                ...
                { name: "Dumbbell Romanian Deadlifts", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 3, reps: 10, rest: 90, timePerSet: 60 },
                { name: "Dumbbell Lunges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 3, reps: 10, rest: 90, timePerSet: 60 },
                ...
                { name: "Dumbbell Goblet Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 3, reps: 10, rest: 90, timePerSet: 50 },
                { name: "Dumbbell Calf Raises", muscleGroup: "legs & back, calves", label: "1", equipment: "Dumbbells", sets: 3, reps: 12, rest: 90, timePerSet: 20 },
            ],
            barbells: [
                { name: "Barbell Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 3, reps: 8, rest: 90, timePerSet: 60 },
                ...
                { name: "Barbell Lunges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 3, reps: 10, rest: 90, timePerSet: 75 },
                ...
                { name: "Barbell Calf Raises", muscleGroup: "legs & back, calves", label: "1", equipment: "Barbells", sets: 3, reps: 12, rest: 90, timePerSet: 25 },
            ],
            machines: [
                { name: "Leg Press Machine", muscleGroup: "legs & back", label: "1", equipment: "Machines", sets: 3, reps: 10, rest: 90, timePerSet: 40 },
                { name: "Chest Press Machine", muscleGroup: "chest & triceps", label: "2", equipment: "Machines", sets: 3, reps: 10, rest: 90, timePerSet: 40 },
...
intermediate: {
            barbell: [
                { name: "Barbell Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 5, reps: 5, rest: 180, timePerSet: 75 },
                { name: "Barbell Deadlifts", muscleGroup: "legs & back, lower back", label: "1, 3", equipment: "Barbells", sets: 1, reps: 5, rest: 180, timePerSet: 60 }, // Multi-label
                ...
                { name: "Barbell Power Cleans", muscleGroup: "legs & back, delts & traps, lower back", label: "1, 4", equipment: "Barbells", sets: 3, reps: 3, rest: 120, timePerSet: 45 }, // Multi-label
                { name: "Barbell Front Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 3, reps: 5, rest: 120, timePerSet: 75 },
                { name: "Barbell Good Mornings", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 3, reps: 8, rest: 90, timePerSet: 45 },
                { name: "Barbell Lunges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Barbells", sets: 3, reps: 8, rest: 90, timePerSet: 60 },
            ...
            dumbbells: [
                ...
                { name: "Dumbbell Romanian Deadlifts", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 3, reps: 10, rest: 90, timePerSet: 75 },
                { name: "Dumbbell Lunges", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 3, reps: 10, rest: 90, timePerSet: 75 },
                ...
                { name: "Dumbbell Goblet Squats", muscleGroup: "legs & back, lower back", label: "1", equipment: "Dumbbells", sets: 3, reps: 10, rest: 90, timePerSet: 60 },
                ...
                { name: "Dumbbell Calf Raises", muscleGroup: "legs & back, calves", label: "1", equipment: "Dumbbells", sets: 3, reps: 12, rest: 90, timePerSet: 25 },
            ],
            machines: [
                { name: "Leg Press Machine", muscleGroup: "legs & back", label: "1", equipment: "Machines", sets: 3, reps: 10, rest: 90, timePerSet: 40 },
                { name: "Chest Press Machine", muscleGroup: "chest & triceps", label: "2", equipment: "Machines", sets: 3, reps: 10, rest: 90, timePerSet: 40 },
...
endurance: {
    beginner: {
        bodyweight: [
            ...
            { name: "Step ups", muscleGroup: "legs & back, cardio", label: "1, 5", equipment: "Optional Step", sets: 3, reps: 10, rest: 30, timePerSet: 30 },
        ...
        dumbbells: [
            { name: "Dumbbell Thrusters", muscleGroup: "legs & back, delts & traps, chest & triceps, core & cardio, full body", label: "1, 2, 4, 5", equipment: "Dumbbells", sets: 3, reps: 10, rest: 45, timePerSet: 40 },
     ...
     intermediate: {
        bodyweight: [
            ...
            { name: "Step ups", muscleGroup: "legs & back, cardio", label: "1, 5", equipment: "Optional Step", sets: 4, reps: 15, rest: 30, timePerSet: 35 },
        ...
        dumbbells: [
            { name: "Dumbbell Thrusters", muscleGroup: "legs & back, delts & traps, chest & triceps, core & cardio, full body", label: "1, 2, 4, 5", equipment: "Dumbbells", sets: 4, reps: 12, rest: 45, timePerSet: 45 },
        ...
        gym: [
            ...
            { name: "Assault Bike", muscleGroup: "legs & back, chest & triceps, delts & traps, core & cardio", label: "1, 2, 3, 5", equipment: "Assault Bike", sets: 3, reps: "30 sec", rest: 30, timePerSet: 30 },
...
advanced: {
    bodyweight: [
        ...
        { name: "Step ups (with Weight Vest)", muscleGroup: "legs & back, cardio", label: "1, 5", equipment: "Weight Vest", sets: 4, reps: 20, rest: 30, timePerSet: 40 },
    ...
    dumbbells: [
        { name: "Dumbbell Thrusters", muscleGroup: "legs & back, delts & traps, chest & triceps, core & cardio, full body", label: "1, 2, 4, 5", equipment: "Dumbbells", sets: 5, reps: 15, rest: 45, timePerSet: 50 },
        ...
        { name: "Dumbbell Farmer's Walk (Heavy)", muscleGroup: "delts & traps, full body, core, grip", label: "2, 3, 5", equipment: "Dumbbells", sets: 4, reps: "90 sec", rest: 60, timePerSet: 90 },
        ...
        { name: "Dumbbell Step Ups", muscleGroup: "legs & back, cardio", label: "1, 5", equipment: "Dumbbells, Step", sets: 4, reps: 15, rest: 45, timePerSet: 40 },
    ],
    gym: [
        ...
        { name: "Rowing Machine Intervals (Power Strokes)", muscleGroup: "core & cardio, full body", label: "1, 2, 3, 5", equipment: "Rowing Machine", sets: 5, reps: "30 sec power / 30 sec light", rest: 75, timePerSet: 60 },
        { name: "Stair Climber Intervals (High Speed)", muscleGroup: "core & cardio, legs", label: "1, 5", equipment: "Stair Climber", sets: 5, reps: "45 sec fast / 15 sec slow", rest: 60, timePerSet: 60 },
        { name: "Assault Bike Intervals (Max Effort)", muscleGroup: "core & cardio, full body", label: "1, 2, 3, 5", equipment: "Assault Bike", sets: 5, reps: "20 sec max / 40 sec rest", rest: 90, timePerSet: 60 },
        { name: "Ski Erg Intervals (Explosive Pulls)", muscleGroup: "core & cardio, upper body, core", label: "2, 3, 4, 5", equipment: "Ski Erg", sets: 5, reps: "30 sec hard / 30 sec easy", rest: 75, timePerSet: 60 },
...
fatloss: {
    beginner: {
        bodyweight: [
            ...
            { name: "Walking Lunges", muscleGroup: "legs & back, core & cardio, lower back, glutes", label: "1, 3, 5", equipment: "Bodyweight", sets: 3, reps: "10 per leg", rest: 30, timePerSet: 60 },
            ...
            { name: "Step Ups (low step)", muscleGroup: "legs & back, core & cardio, glutes", label: "1, 3, 5", equipment: "Step", sets: 3, reps: "10 per leg", rest: 30, timePerSet: 45 },
        ],
        dumbbells: [
            ...
            { name: "Dumbbell Thrusters", muscleGroup: "legs & back, delts & traps, chest & triceps, core & cardio, full body", label: "1, 2, 4, 5", equipment: "Dumbbells", sets: 3, reps: 10, rest: 45, timePerSet: 40 },
            { name: "Dumbbell Step ups", muscleGroup: "legs & back, core & cardio, legs, glutes", label: "1, 3, 5", equipment: "Dumbbells, Step", sets: 3, reps: "10 per leg", rest: 30, timePerSet: 45 },
    ...
    intermediate: {
        bodyweight: [
            ...
            { name: "Walking Lunges", muscleGroup: "legs & back, core & cardio, lower back, glutes", label: "1, 3, 5", equipment: "Bodyweight", sets: 3, reps: "12 per leg", rest: 45, timePerSet: 75 },
        ...
        dumbbells: [
            { name: "Dumbbell Snatches", muscleGroup: "legs & back, delts & traps, back & biceps, core & cardio, full body", label: "1, 3, 4, 5", equipment: "Dumbbells", sets: 3, reps: "12 per arm", rest: 45, timePerSet: 45 },
            { name: "Dumbbell Push Press", muscleGroup: "legs & back, delts & traps, chest & triceps, core & cardio", label: "1, 2, 4, 5", equipment: "Dumbbells", sets: 3, reps: 15, rest: 45, timePerSet: 40 },
            { name: "Dumbbell Renegade Rows", muscleGroup: "legs & back, back & biceps, core & cardio", label: "3, 5", equipment: "Dumbbells", sets: 3, reps: "12 per arm", rest: 45, timePerSet: 60 },
            { name: "Dumbbell Walking Lunges", muscleGroup: "legs & back, core & cardio, lower back, glutes", label: "1, 3, 5", equipment: "Dumbbells", sets: 3, reps: "12 per leg", rest: 30, timePerSet: 75 },
            { name: "Dumbbell Burpees", muscleGroup: "legs & back, chest & triceps, delts & traps, core & cardio, full body", label: "1, 2, 3, 5", equipment: "Dumbbells", sets: 3, reps: 10, rest: 45, timePerSet: 60 },
            { name: "Dumbbell Thrusters", muscleGroup: "legs & back, delts & traps, chest & triceps, core & cardio, full body", label: "1, 2, 4, 5", equipment: "Dumbbells", sets: 3, reps: 12, rest: 45, timePerSet: 45 },
...
advanced: {
        bodyweight: [
            ...
            { name: "Advanced Plyometric Circuit", muscleGroup: "legs & back, chest & triceps, delts & traps, core & cardio, full body", label: "1, 2, 3, 5", equipment: "Bodyweight", sets: 4, reps: 15, rest: 45, timePerSet: 60 },
            { name: "Complex Bodyweight Movements (e.g., Burpee Pull-ups)", muscleGroup: "legs & back, back & biceps, chest & triceps, delts & traps, core & cardio, full body", label: "1, 2, 3, 4, 5, 6", equipment: "Pull-up Bar", sets: 4, reps: 10, rest: 60, timePerSet: 75 },
        ...
        gym: [
            ...
            { name: "Assault Bike Intervals (max effort)", muscleGroup: "legs & back, chest & triceps, delts & traps, core & cardio", label: "1, 2, 3, 5", equipment: "Assault Bike", sets: 6, reps: "20 sec sprint / 40 sec rest", rest: 90, timePerSet: 60 },
...
hiit: {
    beginner: [
        ...
        { name: "Walking Lunges", muscleGroup: "legs & back, core & cardio, lower back, glutes", label: "1, 3, 5", equipment: "Bodyweight", sets: 4, reps: "20 sec per leg", rest: 40, timePerSet: 40 },
    ...
    intermediate: [
        ...
        { name: "Walking Lunges with Twist", muscleGroup: "legs & back, core & cardio, lower back, glutes", label: "1, 2, 3, 5", equipment: "Bodyweight", sets: 5, reps: "30 sec per leg", rest: 30, timePerSet: 60 },
        { name: "Dumbbell Thrusters (Light)", muscleGroup: "legs & back, chest & triceps, delts & traps, core & cardio, full body", label: "1, 2, 4, 5", equipment: "Dumbbells", sets: 5, reps: "30 sec", rest: 30, timePerSet: 30 },
    ...
    advanced: [
        { name: "Burpees", muscleGroup: "legs & back, chest & triceps, delts & traps, core & cardio, full body", label: "1, 2, 3, 5", equipment: "Bodyweight", sets: 8, reps: "40 sec", rest: 20, timePerSet: 40 },
        ...
        { name: "Thrusters", muscleGroup: "legs & back, chest & triceps, delts & traps, core & cardio, full body", label: "1, 2, 4, 5", equipment: "Dumbbells or Barbell", sets: 8, reps: "30 sec", rest: 30, timePerSet: 30 },
        ...
        { name: "Bike Sprints (Assault Bike)", muscleGroup: "legs & back, chest & triceps, delts & traps, core & cardio", label: "1, 2, 3, 5", equipment: "Assault Bike", sets: 6, reps: "20 sec", rest: 40, timePerSet: 20 },
...
circuit: {
    ...
    intermediate: [
        ...
        { name: "Walking Lunges with Overhead Reach", muscleGroup: "legs & back, delts & traps, core & cardio, lower back, glutes", label: "1, 2, 3, 4", equipment: "Bodyweight", sets: 4, reps: 10, rest: 10, timePerSet: 50 },
...
hybrid_calisthenics_plus: {
    "beginner": [
        ...
        { name: "Seated Knee Tucks", sets: 3, reps: "8-12", rest: 60, equipment: "none", muscleGroup: "core & cardio, abs, hip flexors", timePerSet: 45, label: "5" },
        ...
        { name: "Glute Bridges", sets: 3, reps: 15, rest: 30, equipment: "none", muscleGroup: "legs & back, lower back, glutes, hamstrings", timePerSet: 30, label: "1" },
        { name: "Suspension Trainer Assisted Squats", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", label: "1", timePerSet: 30, muscleGroup: "legs & back, lower back, glutes" },
        ...
        { name: "Suspension Trainer Pull-ups (feet on ground, high angle)", sets: 3, reps: 6, rest: 60, equipment: "suspension trainer", muscleGroup: "back & biceps, core", timePerSet: 45, label: "1, 3" },
        { name: "Weighted Vest Squats", sets: 3, reps: 10, rest: 60, equipment: "weighted vest", label: "1", timePerSet: 30, muscleGroup: "legs & back, lower back, glutes" },
        ...
        { name: "Suspension Trainer Rows (higher angle)", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "back & biceps, core", timePerSet: 30, label: "1, 3" },
        { name: "Ankle Weight Lunges", sets: 3, reps: 10, rest: 60, equipment: "ankle weights", label: "1", timePerSet: 30, muscleGroup: "legs & back, lower back, glutes" },
        { name: "Resistance Band Glute Bridges", sets: 3, reps: 15, rest: 45, equipment: "resistance band", muscleGroup: "legs & back, lower back, glutes, hamstrings", timePerSet: 30, label: "1" },
        ...
        { name: "Resistance Band Lateral Walks", sets: 3, reps: 10, rest: 45, equipment: "resistance band", label: "1", timePerSet: 30, muscleGroup: "legs & back, lower back, glutes, outer thighs" },
        ...
        { name: "Suspension Trainer Atomic Push-ups (knees)", sets: 3, reps: 8, rest: 60, equipment: "suspension trainer", muscleGroup: "chest & triceps, delts & traps, core & cardio", timePerSet: 45, label: "2, 4, 5" },
        { name: "Towel Pull-ups (assisted, feet on ground)", sets: 3, reps: 6, rest: 60, equipment: "towel, pull-up bar", muscleGroup: "back & biceps, forearms, core", timePerSet: 45, label: "1, 3" },
        { name: "Suspension Trainer Knee Tucks", sets: 3, reps: 15, rest: 45, equipment: "suspension trainer", label: "5", timePerSet: 30, muscleGroup: "core & cardio, hip flexors" },
...
"intermediate": [
    ...
    { name: "Seated Knee Tucks (with ankle weights, light)", sets: 3, reps: "8-12", rest: 60, equipment: "ankle weights", muscleGroup: "core & cardio, abs, hip flexors", timePerSet: 45, label: "5" },
    ...
    { name: "Suspension Trainer Chest Press (steeper angle)", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "chest & triceps, delts & traps, chest, shoulders", timePerSet: 30, label: "2, 4" },
    { name: "Towel Pull-ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "towel, pull-up bar", muscleGroup: "back & biceps, forearms, core", timePerSet: 45, label: "1, 3" },
    ...
    { name: "Suspension Trainer Lunges (single leg focus)", sets: 3, reps: "10 each leg", rest: 60, equipment: "suspension trainer", label: "1", timePerSet: 30, muscleGroup: "legs & back, lower back, legs, glutes, balance" },
    { name: "Weighted Vest Dips (on parallel bars)", sets: 3, reps: 8, rest: 75, equipment: "weighted vest, parallel bars", muscleGroup: "chest & triceps, delts & traps", timePerSet: 45, label: "2, 4" },
    { name: "Resistance Band Squats", sets: 3, reps: 12, rest: 45, equipment: "resistance band", label: "1", timePerSet: 30, muscleGroup: "legs & back, lower back, glutes" },
    { name: "Suspension Trainer Pike Push-ups (knees tucked)", sets: 3, reps: 8, rest: 75, equipment: "suspension trainer", muscleGroup: "chest & triceps, delts & traps", timePerSet: 45, label: "4" },
    ...
    { name: "Resistance Band Rows (single arm)", sets: 3, reps: "10 each arm", rest: 60, equipment: "resistance band", muscleGroup: "legs & back, back & biceps, core & cardio", timePerSet: 30, label: "1, 3, 5" },
    { name: "Suspension Trainer Glute Bridges (single leg)", sets: 3, reps: "10 each leg", rest: 60, equipment: "suspension trainer", muscleGroup: "legs & back, lower back, core & cardio, glutes, hamstrings", timePerSet: 30, label: "1, 5" },
    ...
    { name: "Resistance Band Lateral Walks (longer distance)", sets: 3, reps: "12 steps each way", rest: 45, equipment: "resistance band", label: "1", timePerSet: 30, muscleGroup: "legs & back, lower back, glutes, outer thighs" },
    { name: "Suspension Trainer Bicep Curls (neutral grip)", sets: 3, reps: 10, rest: 45, equipment: "suspension trainer", muscleGroup: "back & biceps, forearms", timePerSet: 30, label: "3" },
    ...
    { name: "Suspension Trainer Atomic Push-ups (feet on ground)", sets: 3, reps: 8, rest: 60, equipment: "suspension trainer", muscleGroup: "chest & triceps, delts & traps, core & cardio", timePerSet: 45, label: "2, 4, 5" },
    ...
    { name: "Suspension Trainer Knee Tucks (hanging)", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer, pull-up bar", label: "5", timePerSet: 30, muscleGroup: "core & cardio, hip flexors" },
...
"advanced": [
    ...
    { name: "Seated Knee Tucks (with ankle weights, moderate)", sets: 3, reps: "8-12", rest: 60, equipment: "ankle weights", muscleGroup: "core & cardio, abs, hip flexors", timePerSet: 45, label: "5" },
    { name: "Supermans (With wrist & ankle weights)", sets: 4, reps: "15 sec hold", rest: 60, equipment: "none", muscleGroup: "core & cardio, lower back, glutes", timePerSet: 45, label: "5" },
    ...
    { name: "Towel rows (Suspension Trainer, very challenging angle, slow tempo)", sets: 3, reps: "6-10", rest: 90, equipment: "towel, suspension trainer", muscleGroup: "back & biceps, forearms", timePerSet: 45, label: "3" },
    ...
    { name: "Weighted Vest Pistol Squats", sets: 3, reps: "5-8 each leg", rest: 90, equipment: "weighted vest", label: "1, balance", timePerSet: 60, muscleGroup: "legs & back, lower back, glutes, core" },
    { name: "Resistance Band Archer Push ups", sets: 3, reps: "6-10 each side", rest: 75, equipment: "resistance band", muscleGroup: "chest & triceps, delts & traps, core & cardio", timePerSet: 60, label: "2, 4, 5" },
    { name: "Suspension Trainer Single Arm Rows (challenging angle)", sets: 3, reps: "8-12 each arm", rest: 75, equipment: "suspension trainer", muscleGroup: "back & biceps, core & cardio", timePerSet: 60, label: "1, 3, 5" },
    { name: "Ankle Weight Leg Raises (Hanging, L-sit variation)", sets: 3, reps: "8-10", rest: 75, equipment: "ankle weights, wrist weights, pull-up bar", label: "5", timePerSet: 60, muscleGroup: "core & cardio, core, hip flexors, forearms" },
    { name: "Weighted Vest Dips (slow negatives)", sets: 3, reps: "6-8", rest: 90, equipment: "weighted vest, parallel bars", muscleGroup: "chest & triceps, delts & traps", timePerSet: 60, label: "2, 4" },
    ...
    { name: "Suspension Trainer Pike Push-ups (elevated feet)", sets: 3, reps: "8-12", rest: 75, equipment: "suspension trainer, elevated surface", muscleGroup: "chest & triceps, delts & traps, core & cardio", timePerSet: 60, label: "2, 4, 5" },
    ...
    { name: "Resistance Band Squat Jumps (explosive, high resistance)", sets: 3, reps: "8-10", rest: 75, equipment: "resistance band", label: "1, explosive", timePerSet: 45, muscleGroup: "legs & back, lower back, glutes, calves" },
    { name: "Suspension Trainer Body Saws (extended range)", sets: 3, reps: "12-15", rest: 60, equipment: "suspension trainer", label: "5", timePerSet: 60, muscleGroup: "core & cardio, shoulders, lats" },
    { name: "Suspension Trainer Pull-ups (single leg raised)", sets: 3, reps: "as many as possible", rest: 75, equipment: "suspension trainer", muscleGroup: "back & biceps, core & cardio", timePerSet: 45, label: "1, 3, 5" },
    { name: "Towel Pull-ups (weighted vest, narrow grip)", sets: 3, reps: "as many as possible", rest: 90, equipment: "towel, pull-up bar, weighted vest", muscleGroup: "back & biceps, forearms, core", timePerSet: 60, label: "1, 3" },
    { name: "Suspension Trainer Single Leg Squats (no assistance)", sets: 3, reps: "5-8 each leg", rest: 90, equipment: "suspension trainer (optional for balance)", label: "1, balance", timePerSet: 60, muscleGroup: "legs & back, lower back, glutes, core" },
    { name: "Towel Curls (Suspension Trainer, very challenging angle, slow tempo)", sets: 3, reps: "6-10", rest: 60, equipment: "towel, suspension trainer", muscleGroup: "back & biceps, forearms", timePerSet: 45, label: "3" },
    ...
    { name: "Suspension Trainer Inverted Rows (horizontal)", sets: 3, reps: "10-15", rest: 60, equipment: "suspension trainer", muscleGroup: "back & biceps, delts & traps, core & cardio", timePerSet: 45, label: "1, 3, 4, 5" },
    ...
    { name: "Suspension Trainer Single-Leg Glute Bridges (weighted vest)", sets: 3, reps: "8-10 each leg", rest: 75, equipment: "suspension trainer, weighted vest", muscleGroup: "legs & back, lower back, core & cardio, glutes, hamstrings", timePerSet: 60, label: "1, 5" },
    { name: "Weighted Vest Pull-ups (slow and controlled)", sets: 3, reps: "5-8", rest: 90, equipment: "weighted vest, pull-up bar", muscleGroup: "back & biceps, back, biceps, lats", timePerSet: 60, label: "3" },
    ...
    { name: "Suspension Trainer Atomic Push-ups (feet elevated, full extension)", sets: 3, reps: "8-12", rest: 75, equipment: "suspension trainer, elevated surface", muscleGroup: "chest & triceps, delts & traps, core & cardio", timePerSet: 60, label: "2, 4, 5" },
    ...
    { name: "Suspension Trainer Leg Curls (single leg)", sets: 3, reps: "10-12 each leg", rest: 60, equipment: "suspension trainer", muscleGroup: "legs & back, core & cardio, hamstrings", timePerSet: 45, label: "1, 5" },
    { name: "Weighted Vest Step-ups (high box, single leg)", sets: 3, reps: "6-8 each leg", rest: 90, equipment: "weighted vest, high box", label: "1, balance", timePerSet: 60, muscleGroup: "legs & back, lower back, glutes, core" },
...
document.getElementById("generate-workout").addEventListener("click", function () {
    ...
    if (trainingSplit === "full_body") {
        ...
        let filteredExercises = availableExercises.filter(exercise => {
            ...
            else if (trainingSplit === "legs_back") return muscleGroupLower.includes("legs") && muscleGroupLower.includes("lower back");
