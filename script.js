...
hybrid_calisthenics_plus: {
    "beginner": [
        { name: "Weighted Vest Squats", sets: 3, reps: 10, rest: 60, equipment: "weighted vest", label: "legs", timePerSet: 30 },
        { name: "Resistance Band Assisted Push ups", sets: 3, reps: 10, rest: 60, equipment: "resistance band", muscleGroup: "chest", timePerSet: 30 },
        { name: "Suspension Trainer Rows", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "back", timePerSet: 30 },
        { name: "Ankle Weight Lunges", sets: 3, reps: 10, rest: 60, equipment: "ankle weights", label: "legs", timePerSet: 30 },
        { name: "Resistance Band Glute Bridges", sets: 3, reps: 15, rest: 45, equipment: "resistance band", muscleGroup: "glutes", timePerSet: 30 },
        { name: "Suspension Trainer Face Pulls", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", muscleGroup: "shoulders, upper back", timePerSet: 30 },
        { name: "Weighted Vest Calf Raises", sets: 3, reps: 15, rest: 45, equipment: "weighted vest", muscleGroup: "calves", timePerSet: 30 },
        { name: "Resistance Band Lateral Walks", sets: 3, reps: 10, rest: 45, equipment: "resistance band", label: "legs, glutes", timePerSet: 30 },
        { name: "Suspension Trainer Bicep Curls", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", muscleGroup: "biceps", timePerSet: 30 },
        { name: "Ankle Weight Flutter Kicks", sets: 3, reps: 20, rest: 30, equipment: "ankle weights", label: "core", timePerSet: 30 },
        { name: "Suspension Trainer Atomic Push-ups (knees)", sets: 3, reps: 8, rest: 60, equipment: "suspension trainer", muscleGroup: "chest, core", timePerSet: 30 },
        { name: "Towel Pull-ups (assisted, feet on ground)", sets: 3, reps: 6, rest: 60, equipment: "towel, pull-up bar", muscleGroup: "back, arms", timePerSet: 30 },
        { name: "Suspension Trainer Knee Tucks", sets: 3, reps: 15, rest: 45, equipment: "suspension trainer", label: "core", timePerSet: 30 },
        { name: "Towel Curls (Suspension Trainer, beginner angle)", sets: 3, reps: 12, rest: 45, equipment: "towel, suspension trainer", muscleGroup: "biceps", timePerSet: 30 }
    ],
    "intermediate": [
        { name: "Weighted Vest Pull ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "weighted vest", muscleGroup: "back", timePerSet: 30 },
        { name: "Resistance Band Push-ups", sets: 3, reps: 12, rest: 60, equipment: "resistance band", muscleGroup: "chest", timePerSet: 30 },
        { name: "Suspension Trainer Inverted Rows", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", muscleGroup: "back", timePerSet: 30 },
        { name: "Wrist Weight Dips", sets: 3, reps: 8, rest: 75, equipment: "wrist weights", muscleGroup: "triceps, chest", timePerSet: 30 },
        { name: "Weighted Vest Step-ups", sets: 3, reps: 10, rest: 60, equipment: "weighted vest", label: "legs, glutes", timePerSet: 30 },
        { name: "Resistance Band Good Mornings", sets: 3, reps: 15, rest: 60, equipment: "resistance band", muscleGroup: "hamstrings, lower back", timePerSet: 30 },
        { name: "Suspension Trainer Tricep Extensions", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", muscleGroup: "triceps", timePerSet: 30 },
        { name: "Ankle Weight Russian Twists", sets: 3, reps: 15, rest: 45, equipment: "ankle weights", label: "core", timePerSet: 30 },
        { name: "Weighted Vest Glute Bridges", sets: 3, reps: 15, rest: 60, equipment: "weighted vest", muscleGroup: "glutes", timePerSet: 30 },
        ...
        { name: "Suspension Trainer Chest Press", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "chest", timePerSet: 30 },
        { name: "Towel Pull-ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "towel, pull-up bar", muscleGroup: "back, arms", timePerSet: 30 },
        { name: "Suspension Trainer Mountain Climbers", sets: 3, reps: 20, rest: 45, equipment: "suspension trainer", label: "core, cardio", timePerSet: 30 },
        { name: "Towel Curls (Suspension Trainer, moderate angle)", sets: 3, reps: 10, rest: 45, equipment: "towel, suspension trainer", muscleGroup: "biceps", timePerSet: 30 },
        { name: "Suspension Trainer Lunges", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", label: "legs", timePerSet: 30 }
    ],
    "advanced": [
        { name: "Weighted Vest Pistol Squats", sets: 3, reps: 5, rest: 90, equipment: "weighted vest", label: "legs, balance", timePerSet: 45 },
        { name: "Resistance Band Archer Push-ups", sets: 3, reps: 6, rest: 75, equipment: "resistance band", muscleGroup: "chest, shoulders, triceps", timePerSet: 45 },
        { name: "Suspension Trainer Single-Arm Rows", sets: 3, reps: 8, rest: 75, equipment: "suspension trainer", muscleGroup: "back, core", timePerSet: 45 },
        { name: "Ankle/Wrist Weight Leg Raises (Hanging)", sets: 3, reps: 10, rest: 60, equipment: "ankle weights, wrist weights", label: "core", timePerSet: 45 },
        { name: "Weighted Vest Dips", sets: 3, reps: "as many as possible", rest: 90, equipment: "weighted vest", muscleGroup: "triceps, chest", timePerSet: 30 },
        { name: "Resistance Band Pull-aparts", sets: 3, reps: 20, rest: 45, equipment: "resistance band", muscleGroup: "shoulders, upper back", timePerSet: 30 },
        { name: "Suspension Trainer Pike Push-ups", sets: 3, reps: 8, rest: 75, equipment: "suspension trainer", muscleGroup: "shoulders, triceps", timePerSet: 45 },
        { name: "Weighted Vest Nordic Hamstring Curls (assisted if needed)", sets: 3, reps: 6, rest: 90, equipment: "weighted vest", muscleGroup: "hamstrings", timePerSet: 45 },
        { name: "Resistance Band Squat Jumps", sets: 3, reps: 10, rest: 60, equipment: "resistance band", label: "legs, explosive", timePerSet: 30 },
        { name: "Suspension Trainer Body Saws", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", label: "core", timePerSet: 45 },
        { name: "Suspension Trainer Pull-ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "suspension trainer", muscleGroup: "back, arms", timePerSet: 30 },
        { name: "Towel Pull-ups (weighted vest)", sets: 3, reps: "as many as possible", rest: 90, equipment: "towel, pull-up bar, weighted vest", muscleGroup: "back, arms", timePerSet: 30 },
        { name: "Suspension Trainer Single-Leg Squats", sets: 3, reps: 6, rest: 90, equipment: "suspension trainer", label: "legs, balance", timePerSet: 45 },
        { name: "Towel Curls (Suspension Trainer, challenging angle)", sets: 3, reps: 8, rest: 60, equipment: "towel, suspension trainer", muscleGroup: "biceps", timePerSet: 45 },
        { name: "Suspension Trainer Tricep Dips", sets: 3, reps: 10, rest: 75, equipment: "suspension trainer", muscleGroup: "triceps, chest", timePerSet: 30 }
    ],
    "all": [
        { name: "Hybrid Circuit (Weighted Vest Squats, Suspension Trainer Rows, Resistance Band Push-ups, Towel Pull-ups)", sets: 3, reps: "8-12 reps each", rest: 90, equipment: "weighted vest, suspension trainer, resistance band, towel, pull-up bar", label: "full body, circuit", timePerSet: 45 },
        { name: "Suspension Trainer Core Series (Knee Tucks, Pikes, Body Saws)", sets: 3, reps: "10-15 reps each", rest: 60, equipment: "suspension trainer", label: "core", timePerSet: 45 },
        { name: "Towel Bicep & Tricep Superset (Suspension Trainer Curls & Extensions)", sets: 3, reps: "10-12 reps each", rest: 75, equipment: "towel, suspension trainer", muscleGroup: "biceps, triceps", timePerSet: 45 },
        { name: "Weighted Lunges with Suspension Trainer Assistance", sets: 3, reps: 10, rest: 75, equipment: "weighted vest, suspension trainer", label: "legs", timePerSet: 45 },
        { name: "Resistance Band Good Mornings with Towel Face Pulls Superset", sets: 3, reps: "15 & 15", rest: 60, equipment: "resistance band, towel", muscleGroup: "hamstrings, lower back, shoulders, upper back", timePerSet: 30 },
        { name: "Suspension Trainer Plank Variations (Regular, Side, Rotating)", sets: 3, reps: "30 seconds each", rest: 45, equipment: "suspension trainer", label: "core", timePerSet: 30 },
        { name: "Towel Rows (Pull-up Bar) with Resistance Band Pulldowns Superset", sets: 3, reps: "8-12 & 12-15", rest: 90, equipment: "towel, pull-up bar, resistance band", muscleGroup: "back, arms", timePerSet: 45 },
        { name: "Suspension Trainer Leg Curl Variations (Hamstring & Glute Focus)", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", muscleGroup: "hamstrings, glutes", timePerSet: 45 },
        { name: "Weighted Push-ups with Resistance Band Resistance", sets: 3, reps: 8, rest: 75, equipment: "weighted vest, resistance band", muscleGroup: "chest, shoulders, triceps", timePerSet: 45 },
        { name: "Suspension Trainer Full Body Blast (Rows, Squats, Chest Press, Tricep Extensions)", sets: 2, reps: "15 reps each", rest: 120, equipment: "suspension trainer", label: "full body, circuit", timePerSet: 45 },
        { name: "Weighted Pull-ups with Resistance Band Assistance (Negative Focus)", sets: 3, reps: "5 negative reps", rest: 75, equipment: "weighted vest, resistance band", muscleGroup: "back", timePerSet: 60 },
        { name: "Suspension Trainer Single-Leg Squats with Ankle Weights", sets: 3, reps: 8, rest: 90, equipment: "suspension trainer, ankle weights", label: "legs, balance", timePerSet: 60 },
        { name: "Resistance Band Bicep Curls with Towel Grip (Pull-up Bar)", sets: 3, reps: 12, rest: 60, equipment: "resistance band, towel, pull-up bar", muscleGroup: "biceps", timePerSet: 30 },
        { name: "Suspension Trainer Tricep Extensions (Overhead) with Weighted Vest", sets: 3, reps: 10, rest: 75, equipment: "suspension trainer, weighted vest", muscleGroup: "triceps", timePerSet: 30 },
        { name: "Hybrid Cardio (Suspension Trainer Jumping Jacks, Resistance Band High Knees)", sets: 3, reps: "30 seconds each", rest: 60, equipment: "suspension trainer, resistance band", label: "cardio, full body", timePerSet: 30 },
        { name: "Towel Rows (Suspension Trainer) with Resistance Band Chest Flyes", sets: 3, reps: "10 & 12", rest: 90, equipment: "towel, suspension trainer, resistance band", muscleGroup: "back, chest", timePerSet: 45 },
        { name: "Weighted Glute Bridges with Resistance Band Abduction", sets: 3, reps: 15, rest: 60, equipment: "weighted vest, resistance band", muscleGroup: "glutes, legs", timePerSet: 30 },
        { name: "Suspension Trainer Oblique Crunches", sets: 3, reps: 15, rest: 45, equipment: "suspension trainer", label: "core, obliques", timePerSet: 30 },
        ...
        { name: "Suspension Trainer Push-up Variations (Incline, Decline, Feet Elevated)", sets: 3, reps: "8-10 each", rest: 75, equipment: "suspension trainer", muscleGroup: "chest, shoulders, triceps", timePerSet: 45 },
        { name: "Resistance Band Lateral Walks with Ankle Weights", sets: 3, reps: "12 steps each way", rest: 45, equipment: "resistance band, ankle weights", label: "legs, glutes", timePerSet: 30 },
        { name: "Suspension Trainer Hamstring Curls with Weighted Vest", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer, weighted vest", muscleGroup: "hamstrings", timePerSet: 45 },
        { name: "Towel Pulldowns (Lat Focus, Pull-up Bar)", sets: 3, reps: 10, rest: 75, equipment: "towel, pull-up bar", muscleGroup: "back, lats", timePerSet: 30 },
        ...
        { name: "Weighted Dips on Parallel Bars with Suspension Trainer Assistance (feet)", sets: 3, reps: 8, rest: 90, equipment: "weighted vest, suspension trainer, parallel bars", muscleGroup: "triceps, chest", timePerSet: 45 },
        { name: "Hybrid Core (Suspension Trainer Rollouts, Resistance Band Anti-Rotation Press)", sets: 3, reps: "8 & 10 each side", rest: 75, equipment: "suspension trainer, resistance band", label: "core", timePerSet: 45 },
        { name: "Towel Face Pulls (Suspension Trainer) with Resistance Band Overhead Press", sets: 3, reps: "12 & 10", rest: 75, equipment: "towel, suspension trainer, resistance band", muscleGroup: "shoulders, upper back", timePerSet: 45 },
        { name: "Suspension Trainer Glute Bridges with Resistance Band Around Knees", sets: 3, reps: 15, rest: 60, equipment: "suspension trainer, resistance band", muscleGroup: "glutes, legs", timePerSet: 30 },
        ...
        { name: "Suspension Trainer Full Body Complex (Rows, Squats, Chest Press, Leg Curls)", sets: 2, reps: "10 reps each", rest: 150, equipment: "suspension trainer", label: "full body, complex", timePerSet: 60 }
