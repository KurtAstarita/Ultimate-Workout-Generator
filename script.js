...
hybrid_calisthenics_plus: {
    "beginner": [
        { name: "Bodyweight Squats", sets: 3, reps: 12, rest: 45, equipment: "none", label: "legs", timePerSet: 30, muscleGroup: "legs, glutes" },
        ...
        { name: "Resistance Band Rows (seated or standing)", sets: 3, reps: 12, rest: 45, equipment: "resistance band", muscleGroup: "back, biceps", timePerSet: 30 },
        { name: "Glute Bridges", sets: 3, reps: 15, rest: 30, equipment: "none", muscleGroup: "glutes, hamstrings", timePerSet: 30 },
        { name: "Suspension Trainer Assisted Squats", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", label: "legs", timePerSet: 30, muscleGroup: "legs, glutes" },
        { name: "Resistance Band Bicep Curls (light resistance)", sets: 3, reps: 12, rest: 45, equipment: "resistance band", muscleGroup: "biceps", timePerSet: 30 },
        { name: "Resistance Band Tricep Extensions (overhead, light resistance)", sets: 3, reps: 12, rest: 45, equipment: "resistance band", muscleGroup: "triceps", timePerSet: 30 },
        { name: "Calf Raises (bodyweight)", sets: 3, reps: 15, rest: 30, equipment: "none", muscleGroup: "calves", timePerSet: 20 },
        { name: "Plank (on forearms)", sets: 3, reps: "30 seconds hold", rest: 45, equipment: "none", label: "core", timePerSet: 30, muscleGroup: "core, shoulders" },
        { name: "Ankle Weight Calf Raises", sets: 3, reps: 15, rest: 45, equipment: "ankle weights", muscleGroup: "calves", timePerSet: 20 },
        { name: "Resistance Band Lateral Walks (short distance, light band)", sets: 3, reps: "8 steps each way", rest: 45, equipment: "resistance band", label: "legs, glutes", timePerSet: 30, muscleGroup: "glutes, outer thighs" },
        { name: "Suspension Trainer Pull-ups (feet on ground, high angle)", sets: 3, reps: 6, rest: 60, equipment: "suspension trainer", muscleGroup: "back, biceps", timePerSet: 45 },
        { name: "Weighted Vest Squats", sets: 3, reps: 10, rest: 60, equipment: "weighted vest", label: "legs", timePerSet: 30, muscleGroup: "legs, glutes" },
        { name: "Resistance Band Assisted Push ups", sets: 3, reps: 10, rest: 60, equipment: "resistance band", muscleGroup: "chest, shoulders, triceps", timePerSet: 30 },
        { name: "Suspension Trainer Rows (higher angle)", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "back, biceps", timePerSet: 30 },
        { name: "Ankle Weight Lunges", sets: 3, reps: 10, rest: 60, equipment: "ankle weights", label: "legs", timePerSet: 30, muscleGroup: "legs, glutes" },
        { name: "Resistance Band Glute Bridges", sets: 3, reps: 15, rest: 45, equipment: "resistance band", muscleGroup: "glutes, hamstrings", timePerSet: 30 },
        { name: "Suspension Trainer Face Pulls (easy angle)", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", muscleGroup: "shoulders, upper back", timePerSet: 30 },
        { name: "Weighted Vest Calf Raises", sets: 3, reps: 15, rest: 45, equipment: "weighted vest", muscleGroup: "calves", timePerSet: 20 },
        { name: "Resistance Band Lateral Walks", sets: 3, reps: 10, rest: 45, equipment: "resistance band", label: "legs, glutes", timePerSet: 30, muscleGroup: "glutes, outer thighs" },
        { name: "Suspension Trainer Bicep Curls (easier angle)", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", muscleGroup: "biceps", timePerSet: 30 },
        { name: "Ankle Weight Flutter Kicks", sets: 3, reps: 20, rest: 30, equipment: "ankle weights", label: "core", timePerSet: 30, muscleGroup: "core, hip flexors" },
        { name: "Suspension Trainer Atomic Push-ups (knees)", sets: 3, reps: 8, rest: 60, equipment: "suspension trainer", muscleGroup: "chest, shoulders, triceps, core", timePerSet: 45 },
        { name: "Towel Pull-ups (assisted, feet on ground)", sets: 3, reps: 6, rest: 60, equipment: "towel, pull-up bar", muscleGroup: "back, biceps", timePerSet: 45 },
        { name: "Suspension Trainer Knee Tucks", sets: 3, reps: 15, rest: 45, equipment: "suspension trainer", label: "core", timePerSet: 30, muscleGroup: "core, hip flexors" },
        ...
        { name: "Resistance Band Good Mornings (light resistance)", sets: 3, reps: 15, rest: 45, equipment: "resistance band", muscleGroup: "hamstrings, glutes, lower back", timePerSet: 30 },
        { name: "Suspension Trainer Tricep Extensions (easier angle)", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", muscleGroup: "triceps", timePerSet: 30 },
        { name: "Side Plank (on forearm)", sets: 3, reps: "30 seconds hold each side", rest: 45, equipment: "none", label: "core, obliques", timePerSet: 30, muscleGroup: "core, obliques, shoulders" }
    ],
"intermediate": [
        { name: "Weighted Vest Pull ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "weighted vest", muscleGroup: "back, biceps, lats", timePerSet: 45 },
        ...
        { name: "Suspension Trainer Lunges (single leg focus)", sets: 3, reps: 10 each leg, rest: 60, equipment: "suspension trainer", label: "legs", timePerSet: 30, muscleGroup: "legs, glutes, balance" },
        { name: "Weighted Vest Dips (on parallel bars)", sets: 3, reps: 8, rest: 75, equipment: "weighted vest, parallel bars", muscleGroup: "triceps, chest, shoulders", timePerSet: 45 },
        { name: "Resistance Band Squats", sets: 3, reps: 12, rest: 45, equipment: "resistance band", label: "legs", timePerSet: 30, muscleGroup: "legs, glutes" },
        { name: "Suspension Trainer Pike Push-ups (knees tucked)", sets: 3, reps: 8, rest: 75, equipment: "suspension trainer", muscleGroup: "shoulders, triceps, upper chest", timePerSet: 45 },
        { name: "Ankle Weight Leg Raises (lying)", sets: 3, reps: 12, rest: 45, equipment: "ankle weights", label: "core", timePerSet: 30, muscleGroup: "core, hip flexors" },
        { name: "Resistance Band Rows (single arm)", sets: 3, reps: 10 each arm, rest: 60, equipment: "resistance band", muscleGroup: "back, biceps, core", timePerSet: 30 },
        { name: "Suspension Trainer Glute Bridges (single leg)", sets: 3, reps: 10 each leg, rest: 60, equipment: "suspension trainer", muscleGroup: "glutes, hamstrings, core", timePerSet: 30 },
        { name: "Weighted Vest Calf Raises (single leg)", sets: 3, reps: 12 each leg, rest: 45, equipment: "weighted vest", muscleGroup: "calves, balance", timePerSet: 30 },
        { name: "Resistance Band Lateral Walks (longer distance)", sets: 3, reps: "12 steps each way", rest: 45, equipment: "resistance band", label: "legs, glutes", timePerSet: 30, muscleGroup: "glutes, outer thighs" },
        { name: "Suspension Trainer Bicep Curls (neutral grip)", sets: 3, reps: 10, rest: 45, equipment: "suspension trainer", muscleGroup: "biceps, forearms", timePerSet: 30 },
        { name: "Ankle Weight Flutter Kicks (elevated legs)", sets: 3, reps: 20, rest: 30, equipment: "ankle weights", label: "core
"advanced": [
        ...
        { name: "Resistance Band Archer Push-ups", sets: 3, reps: 6-10 each side, rest: 75, equipment: "resistance band", muscleGroup: "chest, shoulders, triceps, core", timePerSet: 60 },
        { name: "Suspension Trainer Single-Arm Rows (challenging angle)", sets: 3, reps: 8-12 each arm, rest: 75, equipment: "suspension trainer", muscleGroup: "back, biceps, core", timePerSet: 60 },
        { name: "Ankle/Wrist Weight Leg Raises (Hanging, L-sit variation)", sets: 3, reps: 8-10, rest: 75, equipment: "ankle weights, wrist weights, pull-up bar", label: "core, arms", timePerSet: 60, muscleGroup: "core, hip flexors, forearms" },
...
"all": [
        ...
        { name: "Resistance Band Lateral Walks (longer distance)", sets: 3, reps: "12 steps each way", rest: 45, equipment: "resistance band", label: "legs, glutes", timePerSet: 30, muscleGroup: "glutes, outer thighs" },
        { name: "Suspension Trainer Bicep Curls (neutral grip)", sets: 3, reps: 10, rest: 45, equipment: "suspension trainer", muscleGroup: "biceps, forearms", timePerSet: 30 },
        { name: "Ankle Weight Flutter Kicks (elevated legs)", sets: 3, reps: 20, rest: 30, equipment: "ankle weights", label: "core", timePerSet: 30, muscleGroup: "core, hip flexors" },
        { name: "Suspension Trainer Atomic Push-ups (feet on ground)", sets: 3, reps: 8, rest: 60, equipment: "suspension trainer", muscleGroup: "chest, shoulders, triceps, core", timePerSet: 45 },
        { name: "Towel Pull-ups (narrow grip)", sets: 3, reps: "as many as possible", rest: 75, equipment: "towel, pull-up bar", muscleGroup: "back, biceps, lats", timePerSet: 45 },
        { name: "Suspension Trainer Knee Tucks (hanging)", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer, pull-up bar", label: "core", timePerSet: 30, muscleGroup: "core, hip flexors" },
    ...
    "all": [
        { name: "Hybrid Circuit (Weighted Vest Squats, Suspension Trainer Rows, Resistance Band Push-ups, Towel Pull-ups)", sets: 3, reps: "8-12 reps each", rest: 90, equipment: "weighted vest, suspension trainer, resistance band, towel, pull-up bar", label: "full body, circuit", timePerSet: 45, muscleGroup: "legs, glutes, back, biceps, chest, shoulders, triceps" },
        { name: "Suspension Trainer Core Series (Knee Tucks, Pikes, Body Saws)", sets: 3, reps: "10-15 reps each", rest: 60, equipment: "suspension trainer", label: "core", timePerSet: 45, muscleGroup: "core, shoulders, hip flexors" },
        ...
        { name: "Weighted Lunges with Suspension Trainer Assistance", sets: 3, reps: 10, rest: 75, equipment: "weighted vest, suspension trainer", label: "legs", timePerSet: 45, muscleGroup: "legs, glutes" },
        { name: "Resistance Band Good Mornings with Towel Face Pulls Superset", sets: 3, reps: "15 & 15", rest: 60, equipment: "resistance band, towel", muscleGroup: "hamstrings, glutes, lower back, shoulders, upper back", timePerSet: 30 },
        { name: "Suspension Trainer Plank Variations (Regular, Side, Rotating)", sets: 3, reps: "30 seconds each", rest: 45, equipment: "suspension trainer", label: "core", timePerSet: 30, muscleGroup: "core, shoulders" },
        { name: "Towel Rows (Pull-up Bar) with Resistance Band Pulldowns Superset", sets: 3, reps: "8-12 & 12-15", rest: 90, equipment: "towel, pull-up bar, resistance band", muscleGroup: "back, biceps, lats", timePerSet: 45 },
        ...
        { name: "Suspension Trainer Full Body Blast (Rows, Squats, Chest Press, Tricep Extensions)", sets: 2, reps: "15 reps each", rest: 120, equipment: "suspension trainer", label: "full body, circuit", timePerSet: 45, muscleGroup: "back, biceps, legs, glutes, chest, shoulders, triceps" },
        { name: "Weighted Pull-ups with Resistance Band Assistance (Negative Focus)", sets: 3, reps: "5 negative reps", rest: 75, equipment: "weighted vest, resistance band", muscleGroup: "back, biceps, lats", timePerSet: 60 },
        { name: "Suspension Trainer Single-Leg Squats with Ankle Weights", sets: 3, reps: 8, rest: 90, equipment: "suspension trainer, ankle weights", label: "legs, balance", timePerSet: 60, muscleGroup: "legs, glutes, core" },
        ...
        { name: "Hybrid Cardio (Suspension Trainer Jumping Jacks, Resistance Band High Knees)", sets: 3, reps: "30 seconds each", rest: 60, equipment: "suspension trainer, resistance band", label: "cardio, full body", timePerSet: 30, muscleGroup: "legs, glutes, shoulders, core" },
        ...
        // Adding all Beginner exercises to "all"
        { name: "Bodyweight Squats", sets: 3, reps: 12, rest: 45, equipment: "none", label: "legs", timePerSet: 30, muscleGroup: "legs, glutes" },
        { name: "Resistance Band Pull-aparts", sets: 3, reps: 15, rest: 30, equipment: "resistance band", muscleGroup: "shoulders, upper back", timePerSet: 20 },
        { name: "Incline Push-ups (hands elevated)", sets: 3, reps: 10, rest: 45, equipment: "bench or elevated surface", muscleGroup: "chest, shoulders, triceps", timePerSet: 30 },
