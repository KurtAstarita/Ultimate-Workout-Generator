...
hybrid_calisthenics_plus: {
    "beginner": [
        ...
        { name: "Suspension Trainer Rows", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "back, biceps", timePerSet: 30 },
    ...
    "intermediate": [
        { name: "Weighted Vest Pull ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "weighted vest", muscleGroup: "back, biceps", timePerSet: 45 },
        ...
        { name: "Suspension Trainer Inverted Rows", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", muscleGroup: "back, biceps", timePerSet: 30 },
        { name: "Wrist Weight Dips", sets: 3, reps: 8, rest: 75, equipment: "wrist weights", muscleGroup: "triceps, chest, shoulders", timePerSet: 45 },
        { name: "Weighted Vest Step-ups", sets: 3, reps: 10, rest: 60, equipment: "weighted vest", label: "legs, glutes", timePerSet: 45, muscleGroup: "legs, glutes" },
        ...
        { name: "Ankle Weight Russian Twists", sets: 3, reps: 15, rest: 45, equipment: "ankle weights", label: "core", timePerSet: 30, muscleGroup: "core, obliques" },
        ...
        { name: "Suspension Trainer Chest Press", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "chest, shoulders, triceps", timePerSet: 30 },
        { name: "Towel Pull-ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "towel, pull-up bar", muscleGroup: "back, biceps", timePerSet: 45 },
        { name: "Suspension Trainer Mountain Climbers", sets: 3, reps: 20, rest: 45, equipment: "suspension trainer", label: "core, cardio", timePerSet: 30, muscleGroup: "core, shoulders, legs" },
        ...
        { name: "Suspension Trainer Lunges", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", label: "legs", timePerSet: 30, muscleGroup: "legs, glutes" }
    ],
    "advanced": [
        { name: "Weighted Vest Pistol Squats", sets: 3, reps: 5, rest: 90, equipment: "weighted vest", label: "legs, balance", timePerSet: 45, muscleGroup: "legs, glutes, core" },
        ...
        { name: "Suspension Trainer Single-Arm Rows", sets: 3, reps: 8, rest: 75, equipment: "suspension trainer", muscleGroup: "back, biceps, core", timePerSet: 45 },
        { name: "Ankle/Wrist Weight Leg Raises (Hanging)", sets: 3, reps: 10, rest: 60, equipment: "ankle weights, wrist weights", label: "core", timePerSet: 45, muscleGroup: "core, hip flexors" },
        { name: "Weighted Vest Dips", sets: 3, reps: "as many as possible", rest: 90, equipment: "weighted vest", muscleGroup: "triceps, chest, shoulders", timePerSet: 45 },
        ...
        { name: "Suspension Trainer Pike Push-ups", sets: 3, reps: 8, rest: 75, equipment: "suspension trainer", muscleGroup: "shoulders, triceps, upper chest", timePerSet: 45 },
        { name: "Weighted Vest Nordic Hamstring Curls (assisted if needed)", sets: 3, reps: 6, rest: 90, equipment: "weighted vest", muscleGroup: "hamstrings, glutes", timePerSet: 45 },
        { name: "Resistance Band Squat Jumps", sets: 3, reps: 10, rest: 60, equipment: "resistance band", label: "legs, explosive", timePerSet: 30, muscleGroup: "legs, glutes, calves" },
        { name: "Suspension Trainer Body Saws", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", label: "core", timePerSet: 45, muscleGroup: "core, shoulders" },
        { name: "Suspension Trainer Pull-ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "suspension trainer", muscleGroup: "back, biceps", timePerSet: 45 },
        { name: "Towel Pull-ups (weighted vest)", sets: 3, reps: "as many as possible", rest: 90, equipment: "towel, pull-up bar, weighted vest", muscleGroup: "back, biceps", timePerSet: 45 },
        { name: "Suspension Trainer Single-Leg Squats", sets: 3, reps: 6, rest: 90, equipment: "suspension trainer", label: "legs, balance", timePerSet: 45, muscleGroup: "legs, glutes, core" },
        ...
        { name: "Suspension Trainer Tricep Dips", sets: 3, reps: 10, rest: 75, equipment: "suspension trainer", muscleGroup: "triceps, chest, shoulders", timePerSet: 30 }
    ],
    "all": [
