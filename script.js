...
hybrid_calisthenics_plus: {
    "beginner": [
        { name: "Bodyweight Squats", sets: 3, reps: 12, rest: 45, equipment: "none", label: "1", timePerSet: 30, muscleGroup: "legs, glutes" },
        { name: "Resistance Band Pull-aparts", sets: 3, reps: 15, rest: 30, equipment: "resistance band", muscleGroup: "shoulders, upper back", timePerSet: 20, label: "4" },
        { name: "Incline Push-ups (hands elevated)", sets: 3, reps: 10, rest: 45, equipment: "bench or elevated surface", muscleGroup: "chest, shoulders, triceps", timePerSet: 30, label: "2, 4" },
        { name: "Resistance Band Rows (seated or standing)", sets: 3, reps: 12, rest: 45, equipment: "resistance band", muscleGroup: "back, biceps", timePerSet: 30, label: "1, 3" },
        { name: "Glute Bridges", sets: 3, reps: 15, rest: 30, equipment: "none", muscleGroup: "glutes, hamstrings", timePerSet: 30, label: "1" },
        { name: "Suspension Trainer Assisted Squats", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", label: "1", timePerSet: 30, muscleGroup: "legs, glutes" },
        { name: "Resistance Band Bicep Curls (light resistance)", sets: 3, reps: 12, rest: 45, equipment: "resistance band", muscleGroup: "biceps", timePerSet: 30, label: "3" },
        { name: "Resistance Band Tricep Extensions (overhead, light resistance)", sets: 3, reps: 12, rest: 45, equipment: "resistance band", muscleGroup: "triceps", timePerSet: 30, label: "2" },
        { name: "Calf Raises (bodyweight)", sets: 3, reps: 15, rest: 30, equipment: "none", muscleGroup: "calves", timePerSet: 20, label: "1" },
        { name: "Plank (on forearms)", sets: 3, reps: "30 seconds hold", rest: 45, equipment: "none", label: "5", timePerSet: 30, muscleGroup: "core, shoulders" },
        { name: "Ankle Weight Calf Raises", sets: 3, reps: 15, rest: 45, equipment: "ankle weights", muscleGroup: "calves", timePerSet: 20, label: "1" },
        { name: "Resistance Band Lateral Walks (short distance, light band)", sets: 3, reps: "8 steps each way", rest: 45, equipment: "resistance band", label: "1", timePerSet: 30, muscleGroup: "glutes, outer thighs" },
        { name: "Suspension Trainer Pull-ups (feet on ground, high angle)", sets: 3, reps: 6, rest: 60, equipment: "suspension trainer", muscleGroup: "back, biceps", timePerSet: 45, label: "1, 3" },
        { name: "Weighted Vest Squats", sets: 3, reps: 10, rest: 60, equipment: "weighted vest", label: "1", timePerSet: 30, muscleGroup: "legs, glutes" },
        { name: "Resistance Band Assisted Push ups", sets: 3, reps: 10, rest: 60, equipment: "resistance band", muscleGroup: "chest, shoulders, triceps", timePerSet: 30, label: "2, 4" },
        { name: "Suspension Trainer Rows (higher angle)", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "back, biceps", timePerSet: 30, label: "1, 3" },
        { name: "Ankle Weight Lunges", sets: 3, reps: 10, rest: 60, equipment: "ankle weights", label: "1", timePerSet: 30, muscleGroup: "legs, glutes" },
        { name: "Resistance Band Glute Bridges", sets: 3, reps: 15, rest: 45, equipment: "resistance band", muscleGroup: "glutes, hamstrings", timePerSet: 30, label: "1" },
        { name: "Suspension Trainer Face Pulls (easy angle)", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", muscleGroup: "shoulders, upper back", timePerSet: 30, label: "4" },
        { name: "Weighted Vest Calf Raises", sets: 3, reps: 15, rest: 45, equipment: "weighted vest", muscleGroup: "calves", timePerSet: 20, label: "1" },
        { name: "Resistance Band Lateral Walks", sets: 3, reps: 10, rest: 45, equipment: "resistance band", label: "1", timePerSet: 30, muscleGroup: "glutes, outer thighs" },
        { name: "Suspension Trainer Bicep Curls (easier angle)", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", muscleGroup: "biceps", timePerSet: 30, label: "3" },
        { name: "Ankle Weight Flutter Kicks", sets: 3, reps: 20, rest: 30, equipment: "ankle weights", label: "5", timePerSet: 30, muscleGroup: "core, hip flexors" },
        { name: "Suspension Trainer Atomic Push-ups (knees)", sets: 3, reps: 8, rest: 60, equipment: "suspension trainer", muscleGroup: "chest, shoulders, triceps, core", timePerSet: 45, label: "2, 4, 5" },
        { name: "Towel Pull-ups (assisted, feet on ground)", sets: 3, reps: 6, rest: 60, equipment: "towel, pull-up bar", muscleGroup: "back, biceps", timePerSet: 45, label: "1, 3" },
        { name: "Suspension Trainer Knee Tucks", sets: 3, reps: 15, rest: 45, equipment: "suspension trainer", label: "5", timePerSet: 30, muscleGroup: "core, hip flexors" },
...
"intermediate": [
    ...
    { name: "Resistance Band Push-ups", sets: 3, reps: 12, rest: 60, equipment: "resistance band", muscleGroup: "chest, shoulders, triceps", timePerSet: 30, label: "2, 4" },
    { name: "Suspension Trainer Inverted Rows (feet elevated)", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer, elevated surface", muscleGroup: "back, biceps", timePerSet: 30, label: "1, 3" },
    { name: "Wrist Weight Dips", sets: 3, reps: 8, rest: 75, equipment: "wrist weights", muscleGroup: "triceps, chest, shoulders", timePerSet: 45, label: "2, 4" },
    { name: "Weighted Vest Step-ups", sets: 3, reps: "10 each leg", rest: 60, equipment: "weighted vest, box or step", label: "1", timePerSet: 45, muscleGroup: "legs, glutes" },
    { name: "Resistance Band Good Mornings", sets: 3, reps: 15, rest: 60, equipment: "resistance band", muscleGroup: "hamstrings, glutes, lower back", timePerSet: 30, label: "1" },
    { name: "Suspension Trainer Tricep Extensions (overhead)", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", muscleGroup: "triceps", timePerSet: 30, label: "2" },
    { name: "Ankle Weight Russian Twists", sets: 3, reps: "15 each side", rest: 45, equipment: "ankle weights", label: "5", timePerSet: 30, muscleGroup: "core, obliques" },
    { name: "Weighted Vest Glute Bridges", sets: 3, reps: 15, rest: 60, equipment: "weighted vest", muscleGroup: "glutes, hamstrings", timePerSet: 30, label: "1" },
    { name: "Resistance Band Face Pulls", sets: 3, reps: 15, rest: 45, equipment: "resistance band", muscleGroup: "shoulders, upper back", timePerSet: 30, label: "4" },
    { name: "Suspension Trainer Chest Press (steeper angle)", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "chest, shoulders, triceps", timePerSet: 30, label: "2, 4" },
    { name: "Towel Pull-ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "towel, pull-up bar", muscleGroup: "back, biceps, forearms", timePerSet: 45, label: "1, 3" },
    { name: "Suspension Trainer Mountain Climbers", sets: 3, reps: "20 each leg", rest: 45, equipment: "suspension trainer", label: "5", timePerSet: 30, muscleGroup: "core, shoulders, legs" },
    { name: "Towel Curls (Suspension Trainer, moderate angle)", sets: 3, reps: 10, rest: 45, equipment: "towel, suspension trainer", muscleGroup: "biceps, forearms", timePerSet: 30, label: "3" },
    { name: "Suspension Trainer Lunges (single leg focus)", sets: 3, reps: "10 each leg", rest: 60, equipment: "suspension trainer", label: "1", timePerSet: 30, muscleGroup: "legs, glutes, balance" },
    { name: "Weighted Vest Dips (on parallel bars)", sets: 3, reps: 8, rest: 75, equipment: "weighted vest, parallel bars", muscleGroup: "triceps, chest, shoulders", timePerSet: 45, label: "2, 4" },
    { name: "Resistance Band Squats", sets: 3, reps: 12, rest: 45, equipment: "resistance band", label: "1", timePerSet: 30, muscleGroup: "legs, glutes" },
    { name: "Suspension Trainer Pike Push-ups (knees tucked)", sets: 3, reps: 8, rest: 75, equipment: "suspension trainer", muscleGroup: "shoulders, triceps, upper chest", timePerSet: 45, label: "2, 4" },
    { name: "Ankle Weight Leg Raises (lying)", sets: 3, reps: 12, rest: 45, equipment: "ankle weights", label: "5", timePerSet: 30, muscleGroup: "core, hip flexors" },
    { name: "Resistance Band Rows (single arm)", sets: 3, reps: "10 each arm", rest: 60, equipment: "resistance band", muscleGroup: "back, biceps, core", timePerSet: 30, label: "1, 3, 5" },
    { name: "Suspension Trainer Glute Bridges (single leg)", sets: 3, reps: "10 each leg", rest: 60, equipment: "suspension trainer", muscleGroup: "glutes, hamstrings, core", timePerSet: 30, label: "1, 5" },
    { name: "Weighted Vest Calf Raises (single leg)", sets: 3, reps: "12 each leg", rest: 45, equipment: "weighted vest", muscleGroup: "calves, balance", timePerSet: 30, label: "1" },
    { name: "Resistance Band Lateral Walks (longer distance)", sets: 3, reps: "12 steps each way", rest: 45, equipment: "resistance band", label: "1", timePerSet: 30, muscleGroup: "glutes, outer thighs" },
    { name: "Suspension Trainer Bicep Curls (neutral grip)", sets: 3, reps: 10, rest: 45, equipment: "suspension trainer", muscleGroup: "biceps, forearms", timePerSet: 30, label: "3" },
    { name: "Ankle Weight Flutter Kicks (elevated legs)", sets: 3, reps: 20, rest: 30, equipment: "ankle weights", label: "5", timePerSet: 30, muscleGroup: "core, hip flexors" },
    { name: "Suspension Trainer Atomic Push-ups (feet on ground)", sets: 3, reps: 8, rest: 60, equipment: "suspension trainer", muscleGroup: "chest, shoulders, triceps, core", timePerSet: 45, label: "2, 4, 5" },
    { name: "Towel Pull-ups (narrow grip)", sets: 3, reps: "as many as possible", rest: 75, equipment: "towel, pull-up bar", muscleGroup: "back, biceps, lats", timePerSet: 45, label: "1, 3" },
    { name: "Suspension Trainer Knee Tucks (hanging)", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer, pull-up bar", label: "5", timePerSet: 30, muscleGroup: "core, hip flexors" },
...
"advanced": [
    ...
    { name: "Resistance Band Archer Push ups", sets: 3, reps: "6-10 each side", rest: 75, equipment: "resistance band", muscleGroup: "chest, shoulders, triceps, core", timePerSet: 60, label: "2, 4, 5" },
    { name: "Suspension Trainer Single Arm Rows (challenging angle)", sets: 3, reps: "8-12 each arm", rest: 75, equipment: "suspension trainer", muscleGroup: "back, biceps, core", timePerSet: 60, label: "1, 3, 5" },
    { name: "Ankle/Wrist Weight Leg Raises (Hanging, L-sit variation)", sets: 3, reps: "8-10", rest: 75, equipment: "ankle weights, wrist weights, pull-up bar", label: "5", timePerSet: 60, muscleGroup: "core, hip flexors, forearms" },
    { name: "Weighted Vest Dips (slow negatives)", sets: 3, reps: "6-8", rest: 90, equipment: "weighted vest, parallel bars", muscleGroup: "triceps, chest, shoulders", timePerSet: 60, label: "2, 4" },
    { name: "Resistance Band Pull aparts (super wide grip)", sets: 3, reps: "20-25", rest: 45, equipment: "resistance band", muscleGroup: "shoulders, upper back, rear deltoids", timePerSet: 30, label: "4" },
    { name: "Suspension Trainer Pike Push-ups (elevated feet)", sets: 3, reps: "8-12", rest: 75, equipment: "suspension trainer, elevated surface", muscleGroup: "shoulders, triceps, upper chest, core", timePerSet: 60, label: "2, 4, 5" },
    { name: "Weighted Vest Nordic Hamstring Curls (full range, controlled)", sets: 3, reps: "4-6", rest: 90, equipment: "weighted vest, secure foot hold", muscleGroup: "hamstrings, glutes, lower back", timePerSet: 60, label: "1" },
    { name: "Resistance Band Squat Jumps (explosive, high resistance)", sets: 3, reps: "8-10", rest: 75, equipment: "resistance band", label: "1, explosive", timePerSet: 45, muscleGroup: "legs, glutes, calves" },
    { name: "Suspension Trainer Body Saws (extended range)", sets: 3, reps: "12-15", rest: 60, equipment: "suspension trainer", label: "5", timePerSet: 60, muscleGroup: "core, shoulders, lats" },
    { name: "Suspension Trainer Pull-ups (single leg raised)", sets: 3, reps: "as many as possible", rest: 75, equipment: "suspension trainer", muscleGroup: "back, biceps, core", timePerSet: 45, label: "1, 3, 5" },
    { name: "Towel Pull-ups (weighted vest, narrow grip)", sets: 3, reps: "as many as possible", rest: 90, equipment: "towel, pull-up bar, weighted vest", muscleGroup: "back, biceps, lats, forearms", timePerSet: 60, label: "1, 3" },
    { name: "Suspension Trainer Single Leg Squats (no assistance)", sets: 3, reps: "5-8 each leg", rest: 90, equipment: "suspension trainer (optional for balance)", label: "1, balance", timePerSet: 60, muscleGroup: "legs, glutes, core" },
    { name: "Towel Curls (Suspension Trainer, very challenging angle, slow tempo)", sets: 3, reps: "6-10", rest: 60, equipment: "towel, suspension trainer", muscleGroup: "biceps, forearms", timePerSet: 45, label: "3" },
    { name: "Suspension Trainer Tricep Dips (feet elevated)", sets: 3, reps: "10-15", rest: 75, equipment: "suspension trainer, elevated surface", muscleGroup: "triceps, chest, shoulders, core", timePerSet: 45, label: "2, 4, 5" },
    { name: "Weighted Vest Burpees", sets: 3, reps: "8-10", rest: 90, equipment: "weighted vest", label: "1, 2, 4, 5, full body, cardio", timePerSet: 60, muscleGroup: "legs, glutes, chest, shoulders, triceps, core" },
    { name: "Resistance Band Deadlifts (heavy resistance)", sets: 3, reps: "6-8", rest: 90, equipment: "resistance band", label: "1", timePerSet: 60, muscleGroup: "hamstrings, glutes, lower back" },
    { name: "Suspension Trainer Inverted Rows (horizontal)", sets: 3, reps: "10-15", rest: 60, equipment: "suspension trainer", muscleGroup: "back, biceps, rear deltoids, core", timePerSet: 45, label: "1, 3, 4, 5" },
    { name: "Ankle/Wrist Weight Reverse Crunches (hanging)", sets: 3, reps: "12-15", rest: 60, equipment: "ankle weights, wrist weights, pull-up bar", label: "5", timePerSet: 45, muscleGroup: "lower abs, hip flexors" },
    { name: "Resistance Band Good Mornings (very heavy resistance)", sets: 3, reps: "8-10", rest: 75, equipment: "resistance band", muscleGroup: "hamstrings, glutes, lower back", timePerSet: 45, label: "1" },
    { name: "Suspension Trainer Single-Leg Glute Bridges (weighted vest)", sets: 3, reps: "8-10 each leg", rest: 75, equipment: "suspension trainer, weighted vest", muscleGroup: "glutes, hamstrings, core", timePerSet: 60, label: "1, 5" },
    { name: "Weighted Vest Pull-ups (slow and controlled)", sets: 3, reps: "5-8", rest: 90, equipment: "weighted vest, pull-up bar", muscleGroup: "back, biceps, lats", timePerSet: 60, label: "1, 3" },
    { name: "Resistance Band Push-ups (plyometric)", sets: 3, reps: "8-10", rest: 75, equipment: "resistance band", muscleGroup: "chest, shoulders, triceps, explosive", timePerSet: 45, label: "2, 4" },
    { name: "Suspension Trainer Atomic Push-ups (feet elevated, full extension)", sets: 3, reps: "8-12", rest: 75, equipment: "suspension trainer, elevated surface", muscleGroup: "chest, shoulders, triceps, core", timePerSet: 60, label: "2, 4, 5" },
    ...
    { name: "Suspension Trainer Leg Curls (single leg)", sets: 3, reps: "10-12 each leg", rest: 60, equipment: "suspension trainer", muscleGroup: "hamstrings, glutes, core", timePerSet: 45, label: "1, 5" },
    { name: "Weighted Vest Step-ups (high box, single leg)", sets: 3, reps: "6-8 each leg", rest: 90, equipment: "weighted vest, high box", label: "1, balance", timePerSet: 60, muscleGroup: "legs, glutes, core" },
    { name: "Resistance Band Face Pulls (with external rotation at the end)", sets: 3, reps: "15-20", rest: 45, equipment: "resistance band", muscleGroup: "shoulders, upper back, rotator cuffs", timePerSet: 30, label: "4" },
    { name: "Suspension Trainer Handstand Push-up Negatives (assisted if needed)", sets: 3, reps: "3-5", rest: 120, equipment: "suspension trainer, wall (optional)", muscleGroup: "shoulders, triceps, upper chest, core", timePerSet: 90, label: "2, 4, 5" },
    { name: "Towel Curls (Suspension Trainer, single arm)", sets: 3, reps: "8-12 each arm", rest: 60, equipment: "towel, suspension trainer", muscleGroup: "biceps, forearms, core", timePerSet: 45, label: "3, 5" }
],
"all": [
    // Beginner Exercises
    { name: "Bodyweight Squats", sets: 3, reps: 12, rest: 45, equipment: "none", label: "1", timePerSet: 30, muscleGroup: "legs, glutes" },
