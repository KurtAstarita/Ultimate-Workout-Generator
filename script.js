...
hybrid_calisthenics_plus: {
        "beginner": [
            ...
            { name: "Suspension Trainer Rows", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "back" },
            { name: "Ankle Weight Lunges", sets: 3, reps: 10, rest: 60, equipment: "ankle weights", label: "legs" },
            { name: "Resistance Band Glute Bridges", sets: 3, reps: 15, rest: 45, equipment: "resistance band", muscleGroup: "glutes" },
            { name: "Suspension Trainer Face Pulls", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", muscleGroup: "shoulders, upper back" },
            { name: "Weighted Vest Calf Raises", sets: 3, reps: 15, rest: 45, equipment: "weighted vest", muscleGroup: "calves" },
            { name: "Resistance Band Lateral Walks", sets: 3, reps: 10, rest: 45, equipment: "resistance band", label: "legs, glutes" },
            { name: "Suspension Trainer Bicep Curls", sets: 3, reps: 12, rest: 45, equipment: "suspension trainer", muscleGroup: "biceps" },
            { name: "Ankle Weight Flutter Kicks", sets: 3, reps: 20, rest: 30, equipment: "ankle weights", label: "core" },
            { name: "Suspension Trainer Atomic Push-ups (knees)", sets: 3, reps: 8, rest: 60, equipment: "suspension trainer", muscleGroup: "chest, core" },
            { name: "Towel Pull-ups (assisted, feet on ground)", sets: 3, reps: 6, rest: 60, equipment: "towel, pull-up bar", muscleGroup: "back, arms" },
            { name: "Suspension Trainer Knee Tucks", sets: 3, reps: 15, rest: 45, equipment: "suspension trainer", label: "core" },
            { name: "Towel Curls (Suspension Trainer, beginner angle)", sets: 3, reps: 12, rest: 45, equipment: "towel, suspension trainer", muscleGroup: "biceps" }
        ],
        "intermediate": [
            { name: "Weighted Vest Pull ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "weighted vest", muscleGroup: "back" },
            { name: "Resistance Band Push-ups", sets: 3, reps: 12, rest: 60, equipment: "resistance band", muscleGroup: "chest" },
            { name: "Suspension Trainer Inverted Rows", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", muscleGroup: "back" },
            { name: "Wrist Weight Dips", sets: 3, reps: 8, rest: 75, equipment: "wrist weights", muscleGroup: "triceps, chest" },
            { name: "Weighted Vest Step-ups", sets: 3, reps: 10, rest: 60, equipment: "weighted vest", label: "legs, glutes" },
            { name: "Resistance Band Good Mornings", sets: 3, reps: 15, rest: 60, equipment: "resistance band", muscleGroup: "hamstrings, lower back" },
            { name: "Suspension Trainer Tricep Extensions", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", muscleGroup: "triceps" },
            { name: "Ankle Weight Russian Twists", sets: 3, reps: 15, rest: 45, equipment: "ankle weights", label: "core" },
            { name: "Weighted Vest Glute Bridges", sets: 3, reps: 15, rest: 60, equipment: "weighted vest", muscleGroup: "glutes" },
            { name: "Resistance Band Face Pulls", sets: 3, reps: 15, rest: 45, equipment: "resistance band", muscleGroup: "shoulders, upper back" },
            { name: "Suspension Trainer Chest Press", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", muscleGroup: "chest" },
            { name: "Towel Pull-ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "towel, pull-up bar", muscleGroup: "back, arms" },
            { name: "Suspension Trainer Mountain Climbers", sets: 3, reps: 20, rest: 45, equipment: "suspension trainer", label: "core, cardio" },
            { name: "Towel Curls (Suspension Trainer, moderate angle)", sets: 3, reps: 10, rest: 45, equipment: "towel, suspension trainer", muscleGroup: "biceps" },
            { name: "Suspension Trainer Lunges", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer", label: "legs" }
        ],
        "advanced": [
            { name: "Weighted Vest Pistol Squats", sets: 3, reps: 5, rest: 90, equipment: "weighted vest", label: "legs, balance" },
            { name: "Resistance Band Archer Push-ups", sets: 3, reps: 6, rest: 75, equipment: "resistance band", muscleGroup: "chest, shoulders, triceps" },
            { name: "Suspension Trainer Single-Arm Rows", sets: 3, reps: 8, rest: 75, equipment: "suspension trainer", muscleGroup: "back, core" },
            { name: "Ankle/Wrist Weight Leg Raises (Hanging)", sets: 3, reps: 10, rest: 60, equipment: "ankle weights, wrist weights", label: "core" },
            { name: "Weighted Vest Dips", sets: 3, reps: "as many as possible", rest: 90, equipment: "weighted vest", muscleGroup: "triceps, chest" },
            { name: "Resistance Band Pull-aparts", sets: 3, reps: 20, rest: 45, equipment: "resistance band", muscleGroup: "shoulders, upper back" },
            { name: "Suspension Trainer Pike Push-ups", sets: 3, reps: 8, rest: 75, equipment: "suspension trainer", muscleGroup: "shoulders, triceps" },
            { name: "Weighted Vest Nordic Hamstring Curls (assisted if needed)", sets: 3, reps: 6, rest: 90, equipment: "weighted vest", muscleGroup: "hamstrings" },
            { name: "Resistance Band Squat Jumps", sets: 3, reps: 10, rest: 60, equipment: "resistance band", label: "legs, explosive" },
            { name: "Suspension Trainer Body Saws", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", label: "core" },
            { name: "Suspension Trainer Pull-ups", sets: 3, reps: "as many as possible", rest: 75, equipment: "suspension trainer", muscleGroup: "back, arms" },
            { name: "Towel Pull-ups (weighted vest)", sets: 3, reps: "as many as possible", rest: 90, equipment: "towel, pull-up bar, weighted vest", muscleGroup: "back, arms" },
            { name: "Suspension Trainer Single-Leg Squats", sets: 3, reps: 6, rest: 90, equipment: "suspension trainer", label: "legs, balance" },
        ...
        "all": [
            ...
            { name: "Weighted Lunges with Suspension Trainer Assistance", sets: 3, reps: 10, rest: 75, equipment: "weighted vest, suspension trainer", label: "legs" },
            { name: "Resistance Band Good Mornings with Towel Face Pulls Superset", sets: 3, reps: "15 & 15", rest: 60, equipment: "resistance band, towel", muscleGroup: "hamstrings, lower back, shoulders, upper back" },
            { name: "Suspension Trainer Plank Variations (Regular, Side, Rotating)", sets: 3, reps: "30 seconds each", rest: 45, equipment: "suspension trainer", label: "core" },
            { name: "Towel Rows (Pull-up Bar) with Resistance Band Pulldowns Superset", sets: 3, reps: "8-12 & 12-15", rest: 90, equipment: "towel, pull-up bar, resistance band", muscleGroup: "back, arms" },
            { name: "Suspension Trainer Leg Curl Variations (Hamstring & Glute Focus)", sets: 3, reps: 12, rest: 60, equipment: "suspension trainer", muscleGroup: "hamstrings, glutes" },
            { name: "Weighted Push-ups with Resistance Band Resistance", sets: 3, reps: 8, rest: 75, equipment: "weighted vest, resistance band", muscleGroup: "chest, shoulders, triceps" },
            { name: "Suspension Trainer Full Body Blast (Rows, Squats, Chest Press, Tricep Extensions)", sets: 2, reps: "15 reps each", rest: 120, equipment: "suspension trainer", label: "full body, circuit" },
            { name: "Weighted Pull-ups with Resistance Band Assistance (Negative Focus)", sets: 3, reps: "5 negative reps", rest: 75, equipment: "weighted vest, resistance band", muscleGroup: "back" },
            { name: "Suspension Trainer Single-Leg Squats with Ankle Weights", sets: 3, reps: 8, rest: 90, equipment: "suspension trainer, ankle weights", label: "legs, balance" },
            { name: "Resistance Band Bicep Curls with Towel Grip (Pull-up Bar)", sets: 3, reps: 12, rest: 60, equipment: "resistance band, towel, pull-up bar", muscleGroup: "biceps" },
            { name: "Suspension Trainer Tricep Extensions (Overhead) with Weighted Vest", sets: 3, reps: 10, rest: 75, equipment: "suspension trainer, weighted vest", muscleGroup: "triceps" },
            { name: "Hybrid Cardio (Suspension Trainer Jumping Jacks, Resistance Band High Knees)", sets: 3, reps: "30 seconds each", rest: 60, equipment: "suspension trainer, resistance band", label: "cardio, full body" },
            { name: "Towel Rows (Suspension Trainer) with Resistance Band Chest Flyes", sets: 3, reps: "10 & 12", rest: 90, equipment: "towel, suspension trainer, resistance band", muscleGroup: "back, chest" },
            { name: "Weighted Glute Bridges with Resistance Band Abduction", sets: 3, reps: 15, rest: 60, equipment: "weighted vest, resistance band", muscleGroup: "glutes, legs" },
            { name: "Suspension Trainer Oblique Crunches", sets: 3, reps: 15, rest: 45, equipment: "suspension trainer", label: "core, obliques" },
            ...
            { name: "Suspension Trainer Push-up Variations (Incline, Decline, Feet Elevated)", sets: 3, reps: "8-10 each", rest: 75, equipment: "suspension trainer", muscleGroup: "chest, shoulders, triceps" },
            { name: "Resistance Band Lateral Walks with Ankle Weights", sets: 3, reps: "12 steps each way", rest: 45, equipment: "resistance band, ankle weights", label: "legs, glutes" },
            { name: "Suspension Trainer Hamstring Curls with Weighted Vest", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer, weighted vest", muscleGroup: "hamstrings" },
            { name: "Towel Pulldowns (Lat Focus, Pull-up Bar)", sets: 3, reps: 10, rest: 75, equipment: "towel, pull-up bar", muscleGroup: "back, lats" },
            { name: "Suspension Trainer Bicep Curls with Resistance Band Resistance", sets: 3, reps: 10, rest: 60, equipment: "suspension trainer, resistance band", muscleGroup: "biceps" },
            { name: "Weighted Dips on Parallel Bars with Suspension Trainer Assistance (feet)", sets: 3, reps: 8, rest: 90, equipment: "weighted vest, suspension trainer, parallel bars", muscleGroup: "triceps, chest" },
            { name: "Hybrid Core (Suspension Trainer Rollouts, Resistance Band Anti-Rotation Press)", sets: 3, reps: "8 & 10 each side", rest: 75, equipment: "suspension trainer, resistance band", label: "core" },
            { name: "Towel Face Pulls (Suspension Trainer) with Resistance Band Overhead Press", sets: 3, reps: "12 & 10", rest: 75, equipment: "towel, suspension trainer, resistance band", muscleGroup: "shoulders, upper back" },
            { name: "Suspension Trainer Glute Bridges with Resistance Band Around Knees", sets: 3, reps: 15, rest: 60, equipment: "suspension trainer, resistance band", muscleGroup: "glutes, legs" },
            { name: "Weighted Calf Raises with Towel Grip (Standing)", sets: 3, reps: 15, rest: 45, equipment: "weighted vest, towel", muscleGroup: "calves" },
            { name: "Suspension Trainer Full Body Complex (Rows, Squats, Chest Press, Leg Curls)", sets: 2, reps: "10 reps each", rest: 150, equipment: "suspension trainer", label: "full body, complex" }
