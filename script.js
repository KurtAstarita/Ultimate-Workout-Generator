 ...
 const strength = {
    ...
    advanced: {
        ...
        bodyweight: [
            { name: "Weighted Pull ups", sets: 3, reps: 5, rest: 240, timePerSet: 75 },
            { name: "Weighted Dips", sets: 3, reps: 5, rest: 240, timePerSet: 60 },
            { name: "Pistol Squats", sets: 3, reps: 5, rest: 240, timePerSet: 75 },
            { name: "Handstand Push ups", sets: 3, reps: "As Many As Possible", rest: 240, timePerSet: 90 },
            { name: "Muscle ups", sets: 3, reps: "As Many As Possible", rest: 300, timePerSet: 120 },
            { name: "Planche Leans", sets: 3, reps: "20 sec hold", rest: 240, timePerSet: 20 },
            { name: "Front Lever Holds", sets: 3, reps: "20 sec hold", rest: 240, timePerSet: 20 },
            { name: "One Arm Pull ups Assisted", sets: 3, reps: "As Many As Possible", rest: 300, timePerSet: 90 },
            { name: "Advanced Plank Variations", sets: 3, reps: "90 sec hold", rest: 240, timePerSet: 90 },
            { name: "Weighted Push ups", sets: 3, reps: 5, rest: 240, timePerSet: 60 },
        ],
    },
},
const endurance = {
    beginner: {
        bodyweight: [
            ...
            { name: "Walking", sets: 1, reps: "10 minutes", rest: 0, timePerSet: 600 },
        ...
        gym: [
            { name: "Treadmill Run", sets: 1, reps: "10 minutes", rest: 0, timePerSet: 600 },
            { name: "Elliptical", sets: 1, reps: "10 minutes", rest: 0, timePerSet: 600 },
            { name: "Stationary Bike", sets: 1, reps: "10 minutes", rest: 0, timePerSet: 600 },
        ],
    },
    intermediate: {
        bodyweight: [
            ...
            { name: "Running", sets: 1, reps: "20 minutes", rest: 0, timePerSet: 1200 },
        ...
        gym: [
            { name: "Rowing Machine", sets: 1, reps: "900 seconds", rest: 0, timePerSet: 900 },
            { name: "Assault Bike", sets: 1, reps: "720 seconds", rest: 0, timePerSet: 720 },
            { name: "Stair Climber", sets: 1, reps: "900 seconds", rest: 0, timePerSet: 900 },
    ...
    advanced: {
        bodyweight: [
            { name: "Long Distance Running", sets: 1, reps: "60 minutes", rest: 0, timePerSet: 3600 },
...
const fatloss = {
    beginner: {
        ...
        gym: [
            { name: "Treadmill Walk or Jog", sets: 1, reps: "1200 seconds", rest: 0, timePerSet: 1200 },
            { name: "Elliptical Trainer", sets: 1, reps: "1200 seconds", rest: 0, timePerSet: 1200 },
            { name: "Stationary Bike", sets: 1, reps: "1200 seconds", rest: 0, timePerSet: 1200 },
            { name: "Rowing Machine", sets: 1, reps: "900 seconds", rest: 0, timePerSet: 900 },
...
const powerlifting_5x5 = {
    ...
    intermediate: [
        ...
        { name: "Overhead Press", sets: 5, reps: 5, rest: 240, timePerSet: 75 },
    ...
    advanced: [
        ...
        { name: "Overhead Press", sets: 5, reps: 5, rest: 240, timePerSet: 90 },
...
const hiit = {
    beginner: [
        ...
        { name: "Squat Jumps", sets: 5, reps: "15 sec", rest: 45, timePerSet: 15 },
        { name: "Plank Jacks", sets: 5, reps: "20 sec", rest: 40, timePerSet: 20 },
        { name: "Skater Jumps", sets: 5, reps: "20 sec", rest: 40, timePerSet: 20 },
        { name: "Burpees", sets: 5, reps: "10 sec", rest: 50, timePerSet: 10 },
    ],
    intermediate: [
        { name: "Burpees", sets: 5, reps: "30 sec", rest: 30, timePerSet: 30 },
        { name: "Mountain Climbers", sets: 5, reps: "30 sec", rest: 30, timePerSet: 30 },
        { name: "Jump Squats", sets: 5, reps: "20 sec", rest: 40, timePerSet: 20 },
        { name: "High Plank Jacks", sets: 5, reps: "25 sec", rest: 35, timePerSet: 25 },
        { name: "Skater Jumps", sets: 5, reps: "25 sec", rest: 35, timePerSet: 25 },
        { name: "Push ups", sets: 5, reps: "20 sec", rest: 40, timePerSet: 20 },
        { name: "Dumbbell Thrusters", sets: 5, reps: "20 sec", rest: 40, timePerSet: 20 },
        { name: "Kettlebell Swings", sets: 5, reps: "20 sec", rest: 40, timePerSet: 20 },
        { name: "Box Jumps", sets: 5, reps: "15 sec", rest: 45, timePerSet: 15 },
    ],
    advanced: [
        { name: "Sprints", sets: 5, reps: "30 sec", rest: 30, timePerSet: 30 },
        { name: "Kettlebell Swings", sets: 5, reps: "30 sec", rest: 30, timePerSet: 30 },
        { name: "Burpee Box Jumps", sets: 5, reps: "20 sec", rest: 40, timePerSet: 20 },
        { name: "Thruster Burpees", sets: 5, reps: "20 sec", rest: 40, timePerSet: 20 },
        { name: "Double Unders", sets: 5, reps: "20 sec", rest: 40, timePerSet: 20 },
        { name: "Muscle ups", sets: 5, reps: "AMRAP", rest: 60, timePerSet: 30 }, // Estimating a short burst
        { name: "Pistol Squats Alternating", sets: 5, reps: "20 sec", rest: 40, timePerSet: 20 },
        { name: "Weighted Pull ups", sets: 5, reps: "AMRAP", rest: 60, timePerSet: 20 }, // Estimating a short burst
        { name: "Handstand Push ups", sets: 5, reps: "15 sec", rest: 45, timePerSet: 15 },
    ],
},
const circuit = {
    beginner: [
        { name: "Squats", sets: 3, reps: 10, rest: 15, timePerSet: 20 },
        { name: "Push ups", sets: 3, reps: 10, rest: 15, timePerSet: 20 },
        { name: "Lunges each leg", sets: 3, reps: 10, rest: 15, timePerSet: 40 },
        { name: "Plank", sets: 3, reps: "30 sec", rest: 15, timePerSet: 30 },
        { name: "Jumping Jacks", sets: 3, reps: 30, rest: 15, timePerSet: 30 },
        { name: "High Knees", sets: 3, reps: 30, rest: 15, timePerSet: 30 },
        { name: "Butt Kicks", sets: 3, reps: 30, rest: 15, timePerSet: 30 },
        { name: "Crunches", sets: 3, reps: 15, rest: 15, timePerSet: 20 },
        { name: "Glute Bridges", sets: 3, reps: 15, rest: 15, timePerSet: 20 },
        { name: "Mountain Climbers", sets: 3, reps: 20, rest: 15, timePerSet: 20 },
        { name: "Wall Sit", sets: 3, reps: "30 sec", rest: 15, timePerSet: 30 },
        { name: "Bodyweight Rows using table", sets: 3, reps: 10, rest: 15, timePerSet: 30 },
    ],
    intermediate: [
        { name: "Jump Squats", sets: 3, reps: 12, rest: 20, timePerSet: 25 },
        { name: "Diamond Push ups", sets: 3, reps: 10, rest: 20, timePerSet: 25 },
        { name: "Walking Lunges each leg", sets: 3, reps: 12, rest: 20, timePerSet: 50 },
        { name: "Plank with Shoulder Taps", sets: 3, reps: 10, rest: 20, timePerSet: 30 },
        { name: "Burpees", sets: 3, reps: 10, rest: 20, timePerSet: 40 },
        { name: "Dumbbell Rows", sets: 3, reps: 12, rest: 20, timePerSet: 35 },
        { name: "Dumbbell Thrusters", sets: 3, reps: 10, rest: 20, timePerSet: 35 },
        { name: "Russian Twists", sets: 3, reps: 20, rest: 20, timePerSet: 30 },
        { name: "Box Jumps", sets: 3, reps: 8, rest: 20, timePerSet: 20 },
        { name: "Inverted Rows", sets: 3, reps: 10, rest: 20, timePerSet: 30 },
        { name: "Plank with Leg Raises", sets: 3, reps: 10, rest: 20, timePerSet: 30 },
        { name: "Kettlebell Swings", sets: 3, reps: 12, rest: 20, timePerSet: 25 },
    ],
    advanced: [
        { name: "Burpee Box Jumps", sets: 3, reps: 8, rest: 25, timePerSet: 30 },
        { name: "Handstand Push ups", sets: 3, reps: 6, rest: 25, timePerSet: 45 },
        { name: "Pistol Squats Alternating", sets: 3, reps: 8, rest: 25, timePerSet: 40 },
        { name: "Muscle ups", sets: 3, reps: "AMRAP", rest: 25, timePerSet: 30 }, // Estimating a short burst
        { name: "Weighted Pull ups", sets: 3, reps: 6, rest: 25, timePerSet: 40 },
        { name: "Thruster Burpees", sets: 3, reps: 8, rest: 25, timePerSet: 35 },
        { name: "Double Unders", sets: 3, reps: 20, rest: 25, timePerSet: 20 },
        { name: "Toes to Bar", sets: 3, reps: 8, rest: 25, timePerSet: 30 },
        { name: "Turkish Get ups", sets: 3, reps: 5, rest: 25, timePerSet: 60 },
        { name: "Snatches Dumbbell or Kettlebell", sets: 3, reps: 8, rest: 25, timePerSet: 35 },
        { name: "Front Squats Barbell", sets: 3, reps: 8, rest: 25, timePerSet: 40 },
        { name: "Box Jump Overs", sets: 3, reps: 8, rest: 25, timePerSet: 25 },
    ],
  },
};
