    ...
    try {
        ...
        doc.autoTable({
            ...
            columnStyles: {
                ...
                2: { cellWidth: 'auto' },
                3: { cellWidth: 'auto' },
                4: { cellWidth: 'auto', halign: 'center', cellFormatter: function(data) { return "SET 1 |"; } },
                5: { cellWidth: 'auto', halign: 'center', cellFormatter: function(data) { return "SET 2"; } },
                6: { cellWidth: 'auto', halign: 'center', cellFormatter: function(data) { return "SET 3 |"; } },
                7: { cellWidth: 'auto', halign: 'center', cellFormatter: function(data) { return "SET 4"; } },
                8: { cellWidth: 'auto', halign: 'center', cellFormatter: function(data) { return "SET 5 |"; } },
                9: { cellWidth: 'auto', halign: 'center', cellFormatter: function(data) { return "SET 6"; } },
                10: { cellWidth: 'auto', halign: 'center', cellFormatter: function(data) { return "SET 7 |"; } },
                11: { cellWidth: 'auto', halign: 'center', cellFormatter: function(data) { return "SET 8"; } },
            },
            tableLineWidth: 1,
